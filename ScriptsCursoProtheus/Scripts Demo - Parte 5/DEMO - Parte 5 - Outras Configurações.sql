...
/*****************************************  Outras Configurações no SQL Server *************************************/


-- IFI  (Instant File Initialization x Tempo Restore)
https://luizlima.net/instant-file-initialization-x-tempo-restore/


------------------------------SQL 2016 e versões mais recentes:
...
----------------------------- Para versoes anteriores ao 2016
USE master
...
-- Nivel de Compatibilidade das Bases

SELECT name, Compatibility_level, is_auto_close_on, is_auto_shrink_on
FROM sys.databases
