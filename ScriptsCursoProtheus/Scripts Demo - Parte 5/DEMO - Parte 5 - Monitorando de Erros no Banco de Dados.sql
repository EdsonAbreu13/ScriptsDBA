...
--Conferir o Erro
select * from Curso_Protheus..Log_DB_Error
...
BEGIN
	...
	BEGIN
		...
		from sys.fn_xe_file_target_read_file
			('C:\Temp\CursoProtheus\what_queries_are_failing*.xel',
			'C:\Temp\CursoProtheus\what_queries_are_failing*.xem',
			null, null)
	...
	(set filename = 'C:\Temp\CursoProtheus\what_queries_are_failing.xel' ,
	metadatafile = 'C:\Temp\CursoProtheus\what_queries_are_failing.xem',
	max_file_size = 500,
