...
--------------------- Algumas dicas para se fazer quando tiver um gargalo de CPU
 ...
 -- Gerar um gargalo de CPU
 
 -- Simular 4 queries dessa com 5 iterações no SQLQueryStress
SELECT COUNT(*)
FROM SA1010 
...
--Simular 4 queries dessa no SQLQueryStress
DECLARE @teste INT
SET @teste =1
WHILE 1=1 
	SET @teste = @teste+1
...
WHERE text LIKE N'%SA1010%';  
GO  
-- Remove the specific plan from the cache.  
DBCC FREEPROCCACHE (0x06000600CADA450F9042F5C2F001000001000000000000000000000000000000000000000000000000000000);  
GO  
